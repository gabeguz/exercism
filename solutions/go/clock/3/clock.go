// Package clock implements a simple clock without dates.
package clock
...
// Clock represents the hour and minute of a specific clock.
type Clock struct {
	minute int
	hour   int
}
...
// Add increments the current clock by a number of minutes
func (c Clock) Add(minutes int) Clock {
	c.minute += minutes
	return New(c.hour, c.minute)
}

// Subtract decrements the current clock by a number of minutes
